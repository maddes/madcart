...
class ControllerAccountReward extends Controller {
	public function index() {
		...
		$this->document->setTitle(__('Your Reward Points','account/reward'));
		...
		$this->data['breadcrumbs'][] = array(
				'text' => __('Account','account/reward'),
				'href' => $this->url->link('account/account', '', 'SSL')
		);

		$this->data['breadcrumbs'][] = array(
				'text' => __('Reward Points','account/reward'),
				'href' => $this->url->link('account/reward', '', 'SSL')
		);

		$this->load->model('account/reward');

		$this->data['heading_title'] = __('Your Reward Points','account/reward');

		$this->data['column_date_added'] = __('Date Added','account/reward');
		$this->data['column_description'] = __('Description','account/reward');
		$this->data['column_points'] = __('Points','account/reward');

		$this->data['text_total'] = __('Your total number of reward points is:','account/reward');
		$this->data['text_empty'] = __('You do not have any reward points!','account/reward');
