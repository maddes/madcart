...
class ControllerModuleInformation extends Controller {
	protected function index() {
		...
		$this->data['heading_title'] = __('Information','module/information');
		 
		$this->data['text_contact'] = __('Contact Us','module/information');
		$this->data['text_sitemap'] = __('Site Map','module/information');
