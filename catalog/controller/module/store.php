...
class ControllerModuleStore extends Controller {
	protected function index() {
		...
		if ($status) {
			...
			$this->data['heading_title'] = __('Choose a Store','module/store');
				
			$this->data['text_store'] = __('Please choose the store you wish to visit.','module/store');
