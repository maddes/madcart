...
<div id="content">
	...
	<h1>
		<?php echo __('My Account Information', 'affiliate/edit'); ?>
	</h1>
	<form action="<?php echo $action; ?>" method="post"
		enctype="multipart/form-data">
		<h2>
			<?php echo __('Your Personal Details', 'affiliate/edit'); ?>
		</h2>
		<div class="content">
			<table class="form">
				<tr>
					<td><span class="required">*</span> <?php echo __('First Name:', 'affiliate/edit'); ?>
					</td>
				...
				<tr>
					<td><span class="required">*</span> <?php echo __('Last Name:', 'affiliate/edit'); ?>
					</td>
				...
				<tr>
					<td><span class="required">*</span> <?php echo __('E-Mail:', 'affiliate/edit'); ?>
					</td>
				...
				<tr>
					<td><span class="required">*</span> <?php echo __('Telephone:', 'affiliate/edit'); ?>
					</td>
				...
				<tr>
					<td><?php echo __('Fax:', 'affiliate/edit'); ?></td>
					<td><input type="text" name="fax" value="<?php echo $fax; ?>" /></td>
				</tr>
			</table>
		</div>
		<h2>
			<?php echo __('Your Address', 'affiliate/edit'); ?>
		</h2>
		<div class="content">
			<table class="form">
				<tr>
					<td><?php echo __('Company:', 'affiliate/edit'); ?></td>
					<td><input type="text" name="company"
						value="<?php echo $company; ?>" /></td>
				</tr>
				<tr>
					<td><?php echo __('Web Site:', 'affiliate/edit'); ?></td>
					<td><input type="text" name="website"
						value="<?php echo $website; ?>" /></td>
				</tr>
				<tr>
					<td><span class="required">*</span> <?php echo __('Address 1:', 'affiliate/edit'); ?>
					</td>
				...
				<tr>
					<td><?php echo __('Address 2:', 'affiliate/edit'); ?></td>
					<td><input type="text" name="address_2"
						value="<?php echo $address_2; ?>" /></td>
				</tr>
				<tr>
					<td><span class="required">*</span> <?php echo __('City:', 'affiliate/edit'); ?>
					</td>
				...
				<tr>
					<td><span id="postcode-required" class="required">*</span> <?php echo __('Post Code:', 'affiliate/edit'); ?>
					</td>
				...
				<tr>
					<td><span class="required">*</span> <?php echo __('Country:', 'affiliate/edit'); ?>
					</td>
				...
				<tr>
					<td><span class="required">*</span> <?php echo __('Region / State:', 'affiliate/edit'); ?>
					</td>
