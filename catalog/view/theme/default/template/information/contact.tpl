...
<div id="content">
	...
	<h1>
		<?php echo __('Contact Us', 'information/contact'); ?>
	</h1>
	<form action="<?php echo $action; ?>" method="post"
		enctype="multipart/form-data">
		<h2>
			<?php echo __('Our Location', 'information/contact'); ?>
		</h2>
		<div class="contact-info">
			<div class="content">
				...
				<div class="left">
					<b><?php echo $location['name']; ?> </b><br />
					<?php echo $location['address_1']; ?>
					<br />
					<?php echo $location['address_2']; ?>
					<br />
		...
		<h2>
			<?php echo __('Contact Form', 'information/contact'); ?>
		</h2>
		<div class="content">
			<b><?php echo __('First Name:', 'information/contact'); ?> </b><br />
			<input type="text" name="name" value="<?php echo $name; ?>" /> <br />
			<?php if ($error_name) { ?>
			<span class="error"><?php echo $error_name; ?> </span>
			<?php } ?>
			<br /> <b><?php echo __('E-Mail Address:', 'information/contact'); ?>
			</b><br /> <input type="text" name="email"
				value="<?php echo $email; ?>" /> <br />
			<?php if ($error_email) { ?>
			<span class="error"><?php echo $error_email; ?> </span>
			<?php } ?>
			<br /> <b><?php echo __('Enquiry:', 'information/contact'); ?> </b><br />
			...
			<?php } ?>
			<br /> <b><?php echo __('Enter the code in the box below:', 'information/contact'); ?>
			</b><br /> <input type="text" name="captcha"
				value="<?php echo $captcha; ?>" /> <br /> <img
