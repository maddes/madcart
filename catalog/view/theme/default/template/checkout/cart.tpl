...
<div id="content">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						</a> <?php if (!$product['stock']) { ?> <span class="stock">***</span>
							<?php } ?>
							<div>
								...
								<?php } ?>
							</div> <?php if ($product['reward']) { ?> <small><?php echo $product['reward']; ?>
						</small> <?php } ?></td>
						<td class="model"><?php echo $product['model']; ?></td>
						<td class="quantity"><input type="text"
							name="quantity[<?php echo $product['key']; ?>]"
							value="<?php echo $product['quantity']; ?>" class="input-mini" />
							&nbsp; <input type="image"
							src="catalog/view/theme/default/image/update.png"
							alt="<?php echo $button_update; ?>"
							title="<?php echo $button_update; ?>" /> &nbsp;<a
					...
					<tr>
						...
						<td class="quantity"><input type="text" name="" value="1"
							class="input-mini" disabled="disabled" /> &nbsp;<a
							href="<?php echo $vouchers['remove']; ?>"><img
								src="catalog/view/theme/default/image/remove.png"
								alt="<?php echo $button_remove; ?>"
								title="<?php echo $button_remove; ?>" /> </a></td>
		...
		<table class="radio">
			...
			<tr class="highlight">
				<td><?php if ($next == 'reward') { ?> <input type="radio"
					...
					<input type="radio" name="next" value="reward" id="use_reward" /> <?php } ?>
				</td>
				<td><label for="use_reward"><?php echo $text_use_reward; ?> </label>
				</td>
			</tr>
			<?php } ?>
		...
		<div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
			<form action="<?php echo $action; ?>" method="post"
				...
				&nbsp; <input type="text" name="coupon"
					...
					value="<?php echo $button_coupon; ?>" class="btn" />
			</form>
		</div>
		<div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
			<form action="<?php echo $action; ?>" method="post"
				...
				&nbsp; <input type="text" name="voucher"
					...
					value="<?php echo $button_voucher; ?>" class="btn" />
			</form>
		</div>
		<div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
			<form action="<?php echo $action; ?>" method="post"
				...
				&nbsp; <input type="text" name="reward"
					value="<?php echo $reward; ?>" /> <input type="hidden" name="next"
					value="reward" /> &nbsp; <input type="submit"
					value="<?php echo $button_reward; ?>" class="btn" />
			</form>
		</div>
	...
	<div class="buttons">
		<div class="right">
			<a href="<?php echo $checkout; ?>" class="btn"><?php echo $button_checkout; ?>
			</a>
		</div>
		<div class="center">
			<a href="<?php echo $continue; ?>" class="btn"><?php echo $button_shopping; ?>
			</a>
		</div>
	</div>
