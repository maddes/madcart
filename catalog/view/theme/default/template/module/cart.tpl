<div id="cart">
	<div class="heading">
		<h4>
			<?php echo __('Shopping Cart', 'module/cart'); ?>
		</h4>
		<a><span id="cart-total"><?php echo $text_items; ?>
		</span>
		</a>
	</div>
	<div class="content">
		...
		<div class="mini-cart-info">
			<table>
				...
				<tr>
					...
					<td class="quantity">x&nbsp;<?php echo $product['quantity']; ?>
					</td>
				...
				<tr>
					...
					<td class="total"><?php echo $voucher['amount']; ?>
					</td>
					<td class="remove"><img
						src="catalog/view/theme/default/image/remove-small.png"
						alt="<?php echo $button_remove; ?>"
		...
		<div class="mini-cart-total">
			<table>
				...
				<tr>
					<td class="right"><b><?php echo $total['title']; ?>:</b>
					</td>
					<td class="right"><?php echo $total['text']; ?>
					</td>
				</tr>
				<?php } ?>
			</table>
		...
		<div class="checkout">
			<a href="<?php echo $cart; ?>"><?php echo __('View Cart', 'module/cart'); ?>
			</a> | <a href="<?php echo $checkout; ?>"><?php echo __('Checkout', 'module/cart'); ?>
			</a>
		</div>
		<?php } else { ?>
		<div class="empty">
			<?php echo __('Your shopping cart is empty!', 'module/cart'); ?>
		</div>
		<?php } ?>
	</div>
</div>
