...
<p>
	Issuer:
	<?php echo $exact_issname; ?>
	<br /> Confirmation Number:
	<?php echo $exact_issconf; ?>
</p>
<?php } ?>
<div class="buttons">
	<table>
		<tr>
			<td align="left"></td>
			<td align="right"><a href="<?php echo $confirm; ?>" class="btn"><?php echo $button_confirm; ?>
			</a></td>
		</tr>
	</table>
</div>
...
<div class="buttons">
	<table>
		<tr>
			<td align="left"><a href="<?php echo $back; ?>" class="btn"><?php echo $button_back; ?>
			</a></td>
			<td align="right"></td>
		</tr>
	</table>
...
<?php } else { ?>
<p>An error occurred while processing your payment. Please try again
	later.</p>
<div class="buttons">
	<table>
		<tr>
