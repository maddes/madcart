	...
	<table class="form">
		<tr>
			...
			<td><select name="cc_type">
					...
					<option value="<?php echo $card['value']; ?>">
						<?php echo $card['text']; ?>
					</option>
					<?php } ?>
			</select></td>
		...
		<tr>
			...
			<td><select name="cc_start_date_month">
					...
					<?php } ?>
			</select> / <select name="cc_start_date_year">
					<?php foreach ($year_valid as $year) { ?>
					<option value="<?php echo $year['value']; ?>">
						<?php echo $year['text']; ?>
					</option>
					<?php } ?>
			</select> <?php echo $text_start_date; ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="cc_cvv2" value="" class="input-small" />
			</td>
		</tr>
		<tr>
