...
<div id="content">
	...
	<h1>
		<?php echo __('Change Password', 'account/password'); ?>
	</h1>
	<form action="<?php echo $action; ?>" method="post"
		enctype="multipart/form-data">
		<h2>
			<?php echo __('Your Password', 'account/password'); ?>
		</h2>
		<div class="content">
			<table class="form">
				<tr>
					<td><span class="required">*</span> <?php echo __('Password:', 'account/password'); ?>
					</td>
				...
				<tr>
					<td><span class="required">*</span> <?php echo __('Password Confirm:', 'account/password'); ?>
					</td>
