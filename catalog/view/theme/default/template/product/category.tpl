...
<div id="content">
	...
	<?php if ($categories) { ?>
	<h2>
		<?php echo __('Refine Search', 'product/category'); ?>
	</h2>
	<div class="category-list">
		...
		<ul>
			...
			<li><a href="<?php echo $categories[$i]['href']; ?>"><?php echo $categories[$i]['name']; ?>
			</a></li>
			<?php } ?>
			<?php } ?>
		</ul>
	...
	<div class="product-filter">
		<div class="display">
			<b><?php echo __('Display:', 'product/category'); ?> </b>
			<?php echo __('List', 'product/category'); ?>
			<b>/</b> <a onclick="display('grid');"><?php echo __('Grid', 'product/category'); ?>
			</a>
		</div>
		<div class="limit">
			<b><?php echo __('Show:', 'product/category'); ?> </b> <select
		...
		<div class="sort">
			<b><?php echo __('Sort By:', 'product/category'); ?> </b> <select
				onchange="location = this.value;">
	...
	<div class="product-list">
		...
		<div>
			...
			<div class="price">
				...
				<?php } ?>
				<?php if ($product['tax']) { ?>
				<br /> <span class="price-tax"><?php echo __('Ex Tax:', 'product/category'); ?>
	...
	<div class="content">
		<?php echo __('There are no products to list in this category.', 'product/category'); ?>
	</div>
	<div class="buttons">
		<div class="right">
...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<b><?php echo __('Display:', 'product/category'); ?></b> <?php echo __('List', 'product/category'); ?> <b>/</b> <a onclick="display(\'grid\');"><?php echo __('Grid', 'product/category'); ?></a>');
		...
		$('.display').html('<b><?php echo __('Display:', 'product/category'); ?></b> <a onclick="display(\'list\');"><?php echo __('List', 'product/category'); ?></a> <b>/</b> <?php echo __('Grid', 'product/category'); ?>');
