...
<div id="content">
	...
	<h1>
		<?php echo __('Search', 'product/search'); ?>
	</h1>
	<b><?php echo __('Search Criteria', 'product/search'); ?> </b>
	<div class="content">
		<p>
			<?php echo __('Search:', 'product/search'); ?>
			<?php if ($search) { ?>
			...
			<select name="category_id">
				<option value="0">
					<?php echo __('All Categories', 'product/search'); ?>
				</option>
			...
			<input type="checkbox" name="sub_category" value="1"
				id="sub_category" checked="checked" />
			<?php } else { ?>
			<input type="checkbox" name="sub_category" value="1"
				id="sub_category" />
			<?php } ?>
			<label for="sub_category"><?php echo __('Search in subcategories', 'product/search'); ?>
			</label>
		</p>
		<?php if ($description) { ?>
		...
		<input type="checkbox" name="description" value="1" id="description" />
		<?php } ?>
		<label for="description"><?php echo __('Search in product descriptions', 'product/search'); ?>
		</label>
	</div>
	<div class="buttons">
		<div class="right">
			<input type="button" value="<?php echo $button_search; ?>"
				id="button-search" class="btn" />
		</div>
	</div>
	<h2>
		<?php echo __('Products meeting the search criteria', 'product/search'); ?>
	</h2>
	<?php if ($products) { ?>
	<div class="product-filter">
		<div class="display">
			<b><?php echo __('Display:', 'product/search'); ?> </b>
			<?php echo __('List', 'product/search'); ?>
			<b>/</b> <a onclick="display('grid');"><?php echo __('Grid', 'product/search'); ?>
			</a>
		</div>
		<div class="limit">
			<?php echo __('Show:', 'product/search'); ?>
		...
		<div class="sort">
			<?php echo __('Sort By:', 'product/search'); ?>
			<select onchange="location = this.value;">
	...
	<div class="product-list">
		...
		<div>
			...
			<div class="price">
				...
				<?php } ?>
				<?php if ($product['tax']) { ?>
				<br /> <span class="price-tax"><?php echo __('Ex Tax:', 'product/search'); ?>
	...
	<?php } else { ?>
	<div class="content">
		<?php echo __('There is no product that matches the search criteria.', 'product/search'); ?>
	</div>
	<?php }?>
...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<b><?php echo __('Display:', 'product/search'); ?></b> <?php echo __('List', 'product/search'); ?> <b>/</b> <a onclick="display(\'grid\');"><?php echo __('Grid', 'product/search'); ?></a>');
		...
		$('.display').html('<b><?php echo __('Display:', 'product/search'); ?></b> <a onclick="display(\'list\');"><?php echo __('List', 'product/search'); ?></a> <b>/</b> <?php echo __('Grid', 'product/search'); ?>');
