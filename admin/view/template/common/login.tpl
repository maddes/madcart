...
<div id="content">
	<div class="box"
		style="width: 450px; min-height: 300px; margin-top: 40px; margin-left: auto; margin-right: auto;">
		...
		<div class="box-content">
			...
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					<label class="control-label" for="input-username"><?php echo $entry_username; ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php if ($forgotten) { ?>
						<span class="help-block"><a href="<?php echo $forgotten; ?>"><?php echo $text_forgotten; ?>
						</a> </span>
						<?php } ?>
					</div>
				</div>
