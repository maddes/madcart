				...
				<div class="span12">
					<h2>
						...
						<div class="btn-group pull-right" data-toggle="buttons-radio">
							<button class="btn active" value="day">
								<?php echo $text_day; ?>
							</button>
							<button class="btn" value="week">
								<?php echo $text_week; ?>
							</button>
							<button class="btn" value="month">
								<?php echo $text_month; ?>
							</button>
							<button class="btn" value="year">
								<?php echo $text_year; ?>
							</button>
						</div>
					</h2>
...
<script
	type="text/javascript" src="view/javascript/jquery/flot/jquery.flot.js"></script>
<script
