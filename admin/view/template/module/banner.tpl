				...
				<table id="module"
					...
					<thead>
						<tr>
							...
							<td class="left"><span class="required">*</span> <?php echo $entry_dimension; ?>
							</td>
					...
					<tbody>
						...
						<tr id="module-row<?php echo $module_row; ?>">
							<td class="left"><select
								name="banner_module[<?php echo $module_row; ?>][banner_id]">
							...
							<td class="left"><input type="text"
								name="banner_module[<?php echo $module_row; ?>][width]"
								value="<?php echo $module['width']; ?>"
								placeholder="<?php echo $entry_width; ?>" class="input-mini" />
								<input type="text"
								name="banner_module[<?php echo $module_row; ?>][height]"
								value="<?php echo $module['height']; ?>"
								placeholder="<?php echo $entry_height; ?>" class="input-mini" />
								<?php if (isset($error_dimension[$module_row])) { ?> <span
								class="error"><?php echo $error_dimension[$module_row]; ?> </span>
								<?php } ?></td>
							<td class="left"><select
								name="banner_module[<?php echo $module_row; ?>][layout_id]">
							...
							<td class="left"><select
								name="banner_module[<?php echo $module_row; ?>][position]">
							...
							<td class="left"><select
								name="banner_module[<?php echo $module_row; ?>][status]">
							...
							<td class="right"><input type="text"
								name="banner_module[<?php echo $module_row; ?>][sort_order]"
