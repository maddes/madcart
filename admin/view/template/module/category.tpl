					...
					<tbody>
						...
						<tr id="module-row<?php echo $module_row; ?>">
							<td class="left"><select
								name="category_module[<?php echo $module_row; ?>][layout_id]">
							...
							<td class="left"><select
								name="category_module[<?php echo $module_row; ?>][position]">
							...
							<td class="left"><select
								name="category_module[<?php echo $module_row; ?>][status]">
							...
							<td class="right"><input type="text"
								name="category_module[<?php echo $module_row; ?>][sort_order]"
