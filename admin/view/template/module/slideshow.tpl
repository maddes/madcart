					...
					<tbody>
						...
						<tr id="module-row<?php echo $module_row; ?>">
							<td class="left"><select
								name="slideshow_module[<?php echo $module_row; ?>][banner_id]">
							...
							<td class="left"><input type="text"
								name="slideshow_module[<?php echo $module_row; ?>][width]"
								value="<?php echo $module['width']; ?>"
								placeholder="<?php echo $entry_width; ?>" class="input-mini" />
								<input type="text"
								name="slideshow_module[<?php echo $module_row; ?>][height]"
								...
								<?php } ?></td>
							<td class="left"><select
								name="slideshow_module[<?php echo $module_row; ?>][layout_id]">
							...
							<td class="left"><select
								name="slideshow_module[<?php echo $module_row; ?>][position]">
							...
							<td class="left"><select
								name="slideshow_module[<?php echo $module_row; ?>][status]">
							...
							<td class="right"><input type="text"
								name="slideshow_module[<?php echo $module_row; ?>][sort_order]"
