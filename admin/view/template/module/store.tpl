		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					<div class="control-label" for="input-admin">
						<?php echo $entry_admin; ?>
					</div>
					<div class="controls">
						<label class="radio inline"> <?php if ($store_admin) { ?> <input
							type="radio" name="store_admin" value="1" checked="checked" /> <?php echo $text_yes; ?>
							<?php } else { ?> <input type="radio" name="store_admin"
							value="1" /> <?php echo $text_yes; ?> <?php } ?>
						</label> <label class="radio inline"> <?php if (!$store_admin) { ?>
							<input type="radio" name="store_admin" value="0"
							checked="checked" /> <?php echo $text_no; ?> <?php } else { ?> <input
							type="radio" name="store_admin" value="0" /> <?php echo $text_no; ?>
							<?php } ?>
						</label>
					</div>
				</div>
					...
					<tbody>
						...
						<tr id="module-row<?php echo $module_row; ?>">
							<td class="left"><select
								name="store_module[<?php echo $module_row; ?>][layout_id]">
							...
							<td class="left"><select
								name="store_module[<?php echo $module_row; ?>][position]">
							...
							<td class="left"><select
								name="store_module[<?php echo $module_row; ?>][status]">
							...
							<td class="right"><input type="text"
								name="store_module[<?php echo $module_row; ?>][sort_order]"
