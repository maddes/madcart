		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="google_talk_code" cols="40" rows="5"
							id="input-code">
							<?php echo $google_talk_code; ?>
						</textarea>


						<a data-toggle="tooltip" title="<?php echo $help_code; ?>"><i
					...
					<tbody>
						...
						<tr id="module-row<?php echo $module_row; ?>">
							<td class="left"><select
								name="google_talk_module[<?php echo $module_row; ?>][layout_id]">
							...
							<td class="left"><select
								name="google_talk_module[<?php echo $module_row; ?>][position]">
							...
							<td class="left"><select
								name="google_talk_module[<?php echo $module_row; ?>][status]">
							...
							<td class="right"><input type="text"
								name="google_talk_module[<?php echo $module_row; ?>][sort_order]"
