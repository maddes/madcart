			...
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="tabbable tabs-left">
					<ul class="nav nav-tabs" id="module">
						...
						<li><a href="#tab-module<?php echo $module_row; ?>"
							data-toggle="tab"><i class="icon-minus-sign"
								onclick="$('a[href=\'#tab-module<?php echo $module_row; ?>\']').parent().remove(); $('#tab-module<?php echo $module_row; ?>').remove(); $('#module a:first').tab('show');"></i>
								<?php echo $tab_module . ' ' . $module_row; ?> </a></li>
						<?php $module_row++; ?>
						<?php } ?>
						<li id="module-add"><a onclick="addModule();"><i
								class="icon-plus-sign"></i> <?php echo $button_add_module; ?> </a>
						</li>
					</ul>
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-module<?php echo $module_row; ?>">
								...
								<div class="tab-pane"
									...
									<div class="control-group">
										<label class="control-label"
											for="input-description<?php echo $module_row; ?>-language<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?>
										</label>
										<div class="controls">
											<textarea
												name="welcome_module[<?php echo $module_row; ?>][description][<?php echo $language['language_id']; ?>]"
												placeholder="<?php echo $entry_description; ?>"
												id="input-description<?php echo $module_row; ?>-language<?php echo $language['language_id']; ?>">
							...
							<div class="control-group">
								<label class="control-label"
									for="input-layout<?php echo $module_row; ?>"><?php echo $entry_layout; ?>
								</label>
								<div class="controls">
									<select
										name="welcome_module[<?php echo $module_row; ?>][layout_id]"
										id="input-layout<?php echo $module_row; ?>">
							...
							<div class="control-group">
								<label class="control-label"
									for="input-position<?php echo $module_row; ?>"><?php echo $entry_position; ?>
								</label>
								<div class="controls">
									<select
										name="welcome_module[<?php echo $module_row; ?>][position]"
										id="input-position<?php echo $module_row; ?>">
							...
							<div class="control-group">
								<label class="control-label"
									for="input-status<?php echo $module_row; ?>"><?php echo $entry_status; ?>
								</label>
								<div class="controls">
									<select
										name="welcome_module[<?php echo $module_row; ?>][status]"
										id="input-status<?php echo $module_row; ?>">
							...
							<div class="control-group">
								<label class="control-label"
									for="input-sort-order<?php echo $module_row; ?>"><?php echo $entry_sort_order; ?>
								</label>
								<div class="controls">
									<input type="text"
										name="welcome_module[<?php echo $module_row; ?>][sort_order]"
										value="<?php echo $module['sort_order']; ?>"
										placeholder="<?php echo $entry_sort_order; ?>"
										id="input-sort-order<?php echo $module_row; ?>"
										class="input-mini" />
								</div>
							</div>
						</div>
