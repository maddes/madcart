		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox"> <?php if (in_array(0, $manufacturer_store)) { ?>
						...
						<label class="checkbox"> <?php if (in_array($store['store_id'], $manufacturer_store)) { ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="sort_order"
							value="<?php echo $sort_order; ?>" class="input-mini"
