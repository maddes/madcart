		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					<label class="control-label"><span class="required">*</span> <?php echo $entry_group; ?>
					</label>
					<div class="controls">
						...
						<input type="text"
							...
							placeholder="<?php echo $entry_group; ?>" /> <img
				...
				<table id="filter"
					...
					<thead>
						<tr>
							<td class="left"><span class="required">*</span> <?php echo $entry_name ?>
							</td>
					...
					<tbody>
						...
						<tr id="filter-row<?php echo $filter_row; ?>">
							<td class="left"><input type="hidden"
								...
								value="<?php echo $filter['filter_id']; ?>" /> <?php foreach ($languages as $language) { ?>
								<input type="text"
								...
								src="view/image/flags/<?php echo $language['image']; ?>"
								title="<?php echo $language['name']; ?>" /><br /> <?php if (isset($error_filter[$filter_row][$language['language_id']])) { ?>
								<span class="error"><?php echo $error_filter[$filter_row][$language['language_id']]; ?>
							</span> <?php } ?> <?php } ?></td>
							<td class="right"><input type="text"
								name="filter[<?php echo $filter_row; ?>][sort_order]"
								value="<?php echo $filter['sort_order']; ?>"
								placeholder="<?php echo $entry_sort_order; ?>"
								id="input-sort-order" class="input-mini" /></td>
							<td class="left"><a
					...
					<tfoot>
						<tr>
							<td colspan="2"></td>
							<td class="left"><a onclick="addFilterRow();" class="btn"><i
									class="icon-plus-sign"></i> <?php echo $button_add_filter; ?> </a>
							</td>
						</tr>
					</tfoot>
				</table>
