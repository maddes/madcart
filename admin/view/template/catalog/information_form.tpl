				...
				<div class="tab-content">
							...
							<div class="tab-pane"
								...
								<div class="control-group">
									<label class="control-label"
										for="input-title<?php echo $language['language_id']; ?>"><span
									...
									<div class="controls">
										...
										<span class="error"><?php echo $error_title[$language['language_id']]; ?>
										</span>
										<?php } ?>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="input-description"><span
										class="required">*</span> <?php echo $entry_description; ?> </label>
									<div class="controls">
										<textarea
										...
										<span class="error"><?php echo $error_description[$language['language_id']]; ?>
										</span>
										<?php } ?>
									</div>
								</div>
					...
					<div class="tab-pane" id="tab-data">
						<div class="control-group">
							...
							<div class="controls">
								<label class="checkbox"> <?php if (in_array(0, $information_store)) { ?>
								...
								<label class="checkbox"> <?php if (in_array($store['store_id'], $information_store)) { ?>
									...
									type="checkbox" name="information_store[]"
						...
						<div class="control-group">
							<label class="control-label" for="input-bottom"><?php echo $entry_bottom; ?>
							</label>
							<div class="controls">
								<label class="checkbox inline"> <?php if ($bottom) { ?> <input
									type="checkbox" name="bottom" value="1" checked="checked"
									id="input-bottom" /> <?php } else { ?> <input type="checkbox"
									name="bottom" value="1" id="input-bottom" /> <?php } ?>
								</label> <a data-toggle="tooltip"
									title="<?php echo $help_bottom; ?>"><i class="icon-info-sign"></i>
								</a>
							</div>
						</div>
						<div class="control-group">
							...
							<tbody>
								<tr>
									...
									<td class="left"><select
										name="information_layout[0][layout_id]">
											<option value=""></option>
								...
								<tr>
									...
									<td class="left"><select
										name="information_layout[<?php echo $store['store_id']; ?>][layout_id]">
											<option value=""></option>
											<?php foreach ($layouts as $layout) { ?>
