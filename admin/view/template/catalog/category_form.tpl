			...
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="tab-content">
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea
											...
											<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_description'] : ''; ?>
										</textarea>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<textarea
											...
											<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_keyword'] : ''; ?>
										</textarea>
									</div>
								</div>
								<div class="control-group">
					...
					<div class="tab-pane" id="tab-data">
						<div class="control-group">
							<label class="control-label" for="input-parent"><?php echo $entry_parent; ?>
							</label>
							<div class="controls">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<a data-toggle="tooltip" title="<?php echo $help_filter; ?>"><i
									class="icon-info-sign"></i> </a> <br /> <br />
						...
						<div class="control-group">
							...
							<div class="controls">
								<label class="checkbox"> <?php if (in_array(0, $category_store)) { ?>
						...
						<div class="control-group">
							<label class="control-label" for="input-name"><?php echo $entry_image; ?>
							</label>
							<div class="controls">
								<ul class="thumbnails">
									<li><a class="thumbnail" href="#"><img alt=""
											src="<?php echo $thumb; ?>"> </a>
										<ul class="thumbnail-option">
											<li><a href="#" title="Edit"><span class="icon-edit"></span>
											</a></li>
											<li><a href="#" title="Delete"><span class="icon-trash"></span>
											</a></li>
										</ul>
									</li>
								</ul>
								<div class="btn-group">
									...
									<button
										onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>'); $('#image').attr('value', '');"
										class="btn btn-small">
						...
						<div class="control-group">
							<label class="control-label" for="input-top"><?php echo $entry_top; ?>
							</label>
							<div class="controls">
								<label class="checkbox inline"> <?php if ($top) { ?> <input
									type="checkbox" name="top" value="1" checked="checked"
									id="input-top" /> <?php } else { ?> <input type="checkbox"
									name="top" value="1" id="input-top" /> <?php } ?>
								</label> <a data-toggle="tooltip"
									data-original-title="<?php echo $help_top; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-column"><?php echo $entry_column; ?>
							</label>
							<div class="controls">
								<input type="text" name="column" value="<?php echo $column; ?>"
									...
									title="<?php echo $help_column; ?>"><i class="icon-info-sign"></i>
								</a>
							</div>
						</div>
						<div class="control-group">
							...
							<tbody>
								...
								<tr>
									...
									<td class="left"><select
										name="category_layout[<?php echo $store['store_id']; ?>][layout_id]">
											<option value=""></option>
											<?php foreach ($layouts as $layout) { ?>
...
<div id="modal" style="width: 60%; height: 60%;" class="modal hide fade"
	...
	<div class="modal-header">
		...
		<h3 id="modal-label">
			<?php echo $text_image_manager; ?>
		</h3>
	</div>
	<div class="modal-body">
		<iframe
			src="index.php?route=common/filemanager&token=<?php echo $token; ?>"
			style="width: 90%; height: 90%;" frameborder="no" scrolling="auto"></iframe>
	</div>
</div>
<script
