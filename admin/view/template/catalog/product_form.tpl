		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<ul class="nav nav-tabs">
					...
					<li><a href="#tab-data" data-toggle="tab"><?php echo $tab_data; ?>
					</a></li>
					<li><a href="#tab-links" data-toggle="tab"><?php echo $tab_links; ?>
					</a></li>
					<li><a href="#tab-attribute" data-toggle="tab"><?php echo $tab_attribute; ?>
					</a></li>
					<li><a href="#tab-option" data-toggle="tab"><?php echo $tab_option; ?>
					</a></li>
					<li><a href="#tab-discount" data-toggle="tab"><?php echo $tab_discount; ?>
					</a></li>
					<li><a href="#tab-special" data-toggle="tab"><?php echo $tab_special; ?>
					</a></li>
					<li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?>
					</a></li>
					<li><a href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?>
					</a></li>
					<li><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?>
					</a></li>
				</ul>
				<div class="tab-content">
							...
							<div class="tab-pane"
								...
								<div class="control-group">
									<label class="control-label"
										for="input-name<?php echo $language['language_id']; ?>"><span
									...
									<div class="controls">
										...
										<span class="error"><?php echo $error_name[$language['language_id']]; ?>
										</span>
										<?php } ?>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label"
										for="input-meta-description<?php echo $language['language_id']; ?>"><?php echo $entry_meta_description; ?>
									</label>
									<div class="controls">
										<textarea
								...
								<div class="control-group">
									<label class="control-label"
										for="input-meta-keyword<?php echo $language['language_id']; ?>"><?php echo $entry_meta_keyword; ?>
									</label>
									<div class="controls">
										<textarea
								...
								<div class="control-group">
									<label class="control-label"
										for="input-description<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?>
									</label>
									<div class="controls">
										<textarea
								...
								<div class="control-group">
									<label class="control-label"
										for="input-tag<?php echo $language['language_id']; ?>"><?php echo $entry_tag; ?>
									</label>
									<div class="controls">
										<input type="text"
											...
											class="input-xxlarge" /> <a data-toggle="tooltip"
											title="<?php echo $help_tag; ?>"><i class="icon-info-sign"></i>
										</a>
									</div>
								</div>
							</div>
					...
					<div class="tab-pane" id="tab-data">
						<div class="control-group">
							<label class="control-label" for="input-model"><span
								class="required">*</span> <?php echo $entry_model; ?> </label>
							<div class="controls">
						...
						<div class="control-group">
							<label class="control-label" for="input-sku"><?php echo $entry_sku; ?>
							</label>
							<div class="controls">
								<input type="text" name="sku" value="<?php echo $sku; ?>"
									placeholder="<?php echo $entry_sku; ?>" id="input-sku" /> <a
									data-toggle="tooltip" title="<?php echo $help_sku; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-upc"><?php echo $entry_upc; ?>
							</label>
							<div class="controls">
								<input type="text" name="upc" value="<?php echo $upc; ?>"
									placeholder="<?php echo $entry_upc; ?>" id="input-upc" /> <a
									data-toggle="tooltip" title="<?php echo $help_upc; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-ean"><?php echo $entry_ean; ?>
							</label>
							<div class="controls">
								<input type="text" name="ean" value="<?php echo $ean; ?>"
									placeholder="<?php echo $entry_ean; ?>" id="input-ean" /> <a
									data-toggle="tooltip" title="<?php echo $help_ean; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-jan"><?php echo $entry_jan; ?>
							</label>
							<div class="controls">
								<input type="text" name="jan" value="<?php echo $jan; ?>"
									placeholder="<?php echo $entry_jan; ?>" id="input-jan" /> <a
									data-toggle="tooltip" title="<?php echo $help_jan; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-isbn"><?php echo $entry_isbn; ?>
							</label>
							<div class="controls">
								<input type="text" name="isbn" value="<?php echo $isbn; ?>"
									placeholder="<?php echo $entry_isbn; ?>" id="input-isbn" /> <a
									data-toggle="tooltip" title="<?php echo $help_isbn; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-mpn"><?php echo $entry_mpn; ?>
							</label>
							<div class="controls">
								<input type="text" name="mpn" value="<?php echo $mpn; ?>"
									placeholder="<?php echo $entry_mpn; ?>" id="input-mpn" /> <a
									data-toggle="tooltip" title="<?php echo $help_mpn; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-location"><?php echo $entry_location; ?>
							</label>
							<div class="controls">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="quantity"
									...
									id="input-quantity" class="input-mini" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-minimum"><?php echo $entry_minimum; ?>
							</label>
							<div class="controls">
								<input type="text" name="minimum"
									...
									title="<?php echo $help_minimum; ?>"><i class="icon-info-sign"></i>
								</a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-subtract"><?php echo $entry_subtract; ?>
							</label>
							<div class="controls">
						...
						<div class="control-group">
							...
							<div class="controls inline">
								<label class="radio inline"> <?php if ($shipping) { ?> <input
									type="radio" name="shipping" value="1" checked="checked" /> <?php echo $text_yes; ?>
									<?php } else { ?> <input type="radio" name="shipping" value="1" />
									<?php echo $text_yes; ?> <?php } ?>
								</label> <label class="radio inline"> <?php if (!$shipping) { ?>
									<input type="radio" name="shipping" value="0" checked="checked" />
									<?php echo $text_no; ?> <?php } else { ?> <input type="radio"
									name="shipping" value="0" /> <?php echo $text_no; ?> <?php } ?>
								</label>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-keyword"><?php echo $entry_keyword; ?>
							</label>
							<div class="controls">
								<input type="text" name="keyword"
									value="<?php echo $keyword; ?>"
									placeholder="<?php echo $entry_keyword; ?>" id="input-keyword" />
								<a data-toggle="tooltip" title="<?php echo $help_keyword; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-image"><?php echo $entry_image; ?>
							</label>
							<div class="controls">
								<div class="image">
									<img src="<?php echo $thumb; ?>" alt="" id="thumb"
										class="img-polaroid" /><br /> <input type="hidden"
										name="image" value="<?php echo $image; ?>" id="image" /> <a
										onclick="image_upload('image', 'thumb');"><?php echo $text_browse; ?>
									</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
										onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>'); $('#image').attr('value', '');"><?php echo $text_clear; ?>
									</a>
								</div>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-available"><?php echo $entry_date_available; ?>
							</label>
							<div class="controls">
								<input type="date" name="date_available"
									value="<?php echo $date_available; ?>"
									placeholder="<?php echo $entry_date_available; ?>"
									id="input-available" class="input-medium" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-length"><?php echo $entry_dimension; ?>
							</label>
							<div class="controls">
								<input type="text" name="length" value="<?php echo $length; ?>"
									placeholder="<?php echo $entry_length; ?>" id="input-length"
									class="input-mini" /> <input type="text" name="width"
									value="<?php echo $width; ?>"
									placeholder="<?php echo $entry_width; ?>" id="input-width"
									class="input-mini" /> <input type="text" name="height"
						...
						<div class="control-group">
							<label class="control-label" for="input-weight"><?php echo $entry_weight; ?>
							</label>
							<div class="controls">
					...
					<div class="tab-pane" id="tab-links">
						<div class="control-group">
							<label class="control-label" for="input-manufacturer"><?php echo $entry_manufacturer; ?>
							</label>
							<div class="controls">
								<input type="text" name="manufacturer"
									value="<?php echo $manufacturer ?>"
									placeholder="<?php echo $entry_manufacturer; ?>"
									id="input-manufacturer" /> <input type="hidden"
									name="manufacturer_id" value="<?php echo $manufacturer_id; ?>" />
								<a data-toggle="tooltip"
									title="<?php echo $help_manufacturer; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="input-category"><?php echo $entry_category; ?>
							</label>
							<div class="controls">
								<input type="text" name="category" value=""
									placeholder="<?php echo $entry_category; ?>"
									id="input-category" /> <a data-toggle="tooltip"
									title="<?php echo $help_category; ?>"><i class="icon-info-sign"></i>
								</a> <br />
						...
						<div class="control-group">
							<label class="control-label" for="input-filter"><?php echo $entry_filter; ?>
							</label>
							<div class="controls">
								<input type="text" name="filter" value=""
									placeholder="<?php echo $entry_filter; ?>" id="input-filter" />
								<a data-toggle="tooltip" title="<?php echo $help_filter; ?>"><i
									class="icon-info-sign"></i> </a> <br />
						...
						<div class="control-group">
							...
							<div class="controls">
								<label class="checkbox"> <?php if (in_array(0, $product_store)) { ?>
									<input type="checkbox" name="product_store[]" value="0"
									checked="checked" /> <?php echo $text_default; ?> <?php } else { ?>
									<input type="checkbox" name="product_store[]" value="0" /> <?php echo $text_default; ?>
									<?php } ?>
								</label>
								<?php foreach ($stores as $store) { ?>
								<label class="checkbox"> <?php if (in_array($store['store_id'], $product_store)) { ?>
									<input type="checkbox" name="product_store[]"
									value="<?php echo $store['store_id']; ?>" checked="checked" />
									<?php echo $store['name']; ?> <?php } else { ?> <input
									type="checkbox" name="product_store[]"
						...
						<div class="control-group">
							<label class="control-label" for="input-download"><?php echo $entry_download; ?>
							</label>
							<div class="controls">
								<input type="text" name="download" value=""
									placeholder="<?php echo $entry_download; ?>"
									id="input-download" /> <a data-toggle="tooltip"
									title="<?php echo $help_download; ?>"><i class="icon-info-sign"></i>
								</a> <br />
						...
						<div class="control-group">
							<label class="control-label" for="input-related"><?php echo $entry_related; ?>
							</label>
							<div class="controls">
								<input type="text" name="related" value=""
									placeholder="<?php echo $entry_related; ?>" id="input-related" />
								<a data-toggle="tooltip" title="<?php echo $help_related; ?>"><i
									class="icon-info-sign"></i> </a> <br />
					...
					<div class="tab-pane" id="tab-attribute">
						<table id="attribute"
							...
							<tbody>
								...
								<tr id="attribute-row<?php echo $attribute_row; ?>">
									...
									<td class="left"><?php foreach ($languages as $language) { ?> <textarea
										...
										src="view/image/flags/<?php echo $language['image']; ?>"
										title="<?php echo $language['name']; ?>" /><br /> <?php } ?></td>
									<td class="left"><a
										onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();"
										class="btn"><i class="icon-minus-sign"></i> <?php echo $button_remove; ?>
									</a></td>
								</tr>
								<?php $attribute_row++; ?>
								<?php } ?>
							...
							<tfoot>
								<tr>
									<td colspan="2"></td>
									<td class="left"><a onclick="addAttribute();" class="btn"><i
											class="icon-plus-sign"></i> <?php echo $button_add_attribute; ?>
									</a></td>
								</tr>
							</tfoot>
						</table>
					...
					<div class="tab-pane" id="tab-option">
						<div class="control-group">
							<label class="control-label" for="input-option"><?php echo $entry_option; ?>
							</label>
							<div class="controls">
						...
						<div class="tabbable tabs-left">
							<ul class="nav nav-tabs" id="option">
								...
								<li><a href="#tab-option<?php echo $option_row; ?>"
									data-toggle="tab"><i class="icon-minus-sign"
										onclick="$('a[href=\'#tab-option<?php echo $option_row; ?>\']').parent().remove(); $('#tab-option<?php echo $option_row; ?>').remove(); $('#option a:first').tab('show');"></i>
										<?php echo $product_option['name']; ?> </a></li>
								<?php $option_row++; ?>
								<?php } ?>
							</ul>
							<div class="tab-content">
								...
								<div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
									...
									<div class="control-group">
										<label class="control-label"
											for="input-required<?php echo $option_row; ?>"><?php echo $entry_required; ?>
										</label>
										<div class="controls">
											<select
									...
									<div class="control-group">
										<label class="control-label"
											for="input-value<?php echo $option_row; ?>"><?php echo $entry_option_value; ?>
										</label>
										<div class="controls">
											<input type="text"
										...
										<tfoot>
											<tr>
												...
												<td class="left"><a
													...
													class="btn"><i class="icon-plus-sign"></i> <?php echo $button_add_option_value; ?>
												</a></td>
											</tr>
										</tfoot>
									</table>
					...
					<div class="tab-pane" id="tab-discount">
						<table id="discount"
							...
							<tbody>
								...
								<tr id="discount-row<?php echo $discount_row; ?>">
									...
									<td class="right"><input type="text"
										...
										placeholder="<?php echo $entry_price; ?>" class="input-small" />
									</td>
									<td class="left"><input type="date"
							...
							<tfoot>
								<tr>
									<td colspan="6"></td>
									<td class="left"><a onclick="addDiscount();" class="btn"><i
											class="icon-plus-sign"></i> <?php echo $button_add_discount; ?>
									</a></td>
								</tr>
							</tfoot>
						</table>
					...
					<div class="tab-pane" id="tab-special">
						<table id="special"
							...
							<tfoot>
								<tr>
									<td colspan="5"></td>
									<td class="left"><a onclick="addSpecial();" class="btn"><i
											class="icon-plus-sign"></i> <?php echo $button_add_special; ?>
									</a></td>
								</tr>
							</tfoot>
						</table>
					...
					<div class="tab-pane" id="tab-image">
						<table id="images"
							...
							<tbody>
								...
								<tr id="image-row<?php echo $image_row; ?>">
									<td class="left"><div class="image">
											<img src="<?php echo $product_image['thumb']; ?>" alt=""
												id="thumb<?php echo $image_row; ?>" class="img-polaroid" />
											<input type="hidden"
												name="product_image[<?php echo $image_row; ?>][image]"
												value="<?php echo $product_image['image']; ?>"
												id="image<?php echo $image_row; ?>" /> <br /> <a
												onclick="image_upload('image<?php echo $image_row; ?>', 'thumb<?php echo $image_row; ?>');"><?php echo $text_browse; ?>
											</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
												onclick="$('#thumb<?php echo $image_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $image_row; ?>').attr('value', '');"><?php echo $text_clear; ?>
											</a>
										</div></td>
									<td class="right"><input type="text"
							...
							<tfoot>
								<tr>
									<td colspan="2"></td>
									<td class="left"><a onclick="addImage();" class="btn"><i
											class="icon-plus-sign"></i> <?php echo $button_add_image; ?>
									</a></td>
								</tr>
							</tfoot>
						</table>
					...
					<div class="tab-pane" id="tab-reward">
						<div class="control-group">
							<label class="control-label" for="input-points"><?php echo $entry_points; ?>
							</label>
							<div class="controls">
								<input type="text" name="points" value="<?php echo $points; ?>"
									placeholder="<?php echo $entry_points; ?>" id="input-points"
									class="input-small" /> <a data-toggle="tooltip"
									title="<?php echo $help_stock_status; ?>"><i
									class="icon-info-sign"></i> </a>
							</div>
						</div>
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="left"><select
										name="product_layout[<?php echo $store['store_id']; ?>][layout_id]">
											<option value=""></option>
											<?php foreach ($layouts as $layout) { ?>
