			...
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<br /> <span class="error"><?php echo $error_description; ?> </span>
						<?php } ?>
					</div>
				</div>
				<table id="tax-rule"
					...
					<tbody>
						...
						<tr id="tax-rule-row<?php echo $tax_rule_row; ?>">
							...
							<td class="left"><input type="text"
								...
								placeholder="<?php echo $entry_priority; ?>" class="input-mini" />
							</td>
							<td class="left"><a
					...
					<tfoot>
						<tr>
							<td colspan="3"></td>
							<td class="left"><a onclick="addRule();" class="btn"><i
									class="icon-plus-sign"></i> <?php echo $button_add_rule; ?> </a>
							</td>
						</tr>
					</tfoot>
				</table>
