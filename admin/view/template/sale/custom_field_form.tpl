		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<input type="text"
							...
							placeholder="<?php echo $entry_name; ?>" /> <img
				...
				<div class="control-group" id="display-value">
					<label class="control-label" for="input-value"><?php echo $entry_value; ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<label class="checkbox"> <?php if (in_array($customer_group['customer_group_id'], $custom_field_customer_group)) { ?>
							<input type="checkbox"
							...
							<input type="checkbox"
							name="custom_field_customer_group[<?php echo $customer_group_row; ?>][customer_group_id]"
							value="<?php echo $customer_group['customer_group_id']; ?>" /> <?php echo $customer_group['name']; ?>
							<?php } ?>
						</label>
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php $customer_group_row = 0; ?>
						<?php foreach ($customer_groups as $customer_group) { ?>
						<label class="checkbox"> <?php if (in_array($customer_group['customer_group_id'], $custom_field_required)) { ?>
							<input type="checkbox"
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="location" id="input-location">
							...
							<option value="payment_address" selected="selected">
								<?php echo $text_payment_address; ?>
							</option>
							<?php } else { ?>
							<option value="payment_address">
								<?php echo $text_payment_address; ?>
							</option>
							<?php } ?>
							<?php if ($location == 'shipping_address') { ?>
							<option value="shipping_address" selected="selected">
				...
				<div class="control-group">
					<label class="control-label" for="input-position"><?php echo $entry_position; ?>
					</label>
					<div class="controls">
						<select name="position" id="input-position">
							<?php if ($position == 'begining') { ?>
							<option value="begining" selected="selected">
								<?php echo $text_begining; ?>
							</option>
							<?php } else { ?>
							<option value="begining">
								<?php echo $text_begining; ?>
							</option>
							<?php } ?>
							...
							<option value="telephone" selected="selected">
							...
							<?php } ?>
							<?php if ($position == 'fax') { ?>
							<option value="fax" selected="selected">
								<?php echo $text_fax; ?>
							</option>
							<?php } else { ?>
							<option value="fax">
							...
							<option value="customer_group_id" selected="selected">
							...
							<option value="address_1" selected="selected">
							...
							<option value="address_2" selected="selected">
							...
							<option value="postcode" selected="selected">
							...
							<option value="zone_id" selected="selected">
								<?php echo $text_zone; ?>
							</option>
							<?php } else { ?>
							...
							title="<?php echo $help_position; ?>"><i class="icon-info-sign"></i>
						</a>
				...
				<table id="custom-field-value"
					...
					<thead>
						<tr>
							<td class="left"><span class="required">*</span> <?php echo $entry_custom_value; ?>
							</td>
					...
					<tbody>
						...
						<tr
							...
							<td class="left"><input type="hidden"
								...
								<?php foreach ($languages as $language) { ?> <input type="text"
								...
								placeholder="<?php echo $entry_custom_value; ?>" /> <img
								src="view/image/flags/<?php echo $language['image']; ?>"
								title="<?php echo $language['name']; ?>" /><br /> <?php if (isset($error_custom_field_value[$custom_field_value_row][$language['language_id']])) { ?>
								<span class="error"><?php echo $error_custom_field_value[$custom_field_value_row][$language['language_id']]; ?>
							</span> <?php } ?> <?php } ?></td>
					...
					<tfoot>
						<tr>
							<td colspan="2"></td>
							<td class="left"><a onclick="addCustomFieldValue();" class="btn"><i
									class="icon-plus-sign"></i> <?php echo $button_add_custom_field_value; ?>
							</a></td>
						</tr>
					</tfoot>
				</table>
...
<script
	...
	src="view/javascript/jquery/ui/jquery-ui-timepicker-addon.js"></script>
