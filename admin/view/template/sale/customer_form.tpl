		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<ul class="nav nav-tabs">
					...
					<?php if ($customer_id) { ?>
					<li><a href="#tab-history" data-toggle="tab"><?php echo $tab_history; ?>
					</a></li>
					<li><a href="#tab-transaction" data-toggle="tab"><?php echo $tab_transaction; ?>
					</a></li>
					<li><a href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?>
					</a></li>
					<?php } ?>
					<li><a href="#tab-ip" data-toggle="tab"><?php echo $tab_ip; ?> </a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="tab-general">
						<div class="tabbable tabs-left">
							<ul class="nav nav-tabs" id="address">
								<li class="active"><a href="#tab-customer" data-toggle="tab"><?php echo $tab_general; ?>
								</a></li>
								<?php $address_row = 1; ?>
								<?php foreach ($addresses as $address) { ?>
								<li><a href="#tab-address<?php echo $address_row; ?>"
									data-toggle="tab"><i class="icon-minus-sign"
										onclick="$('#address a[href=\'#tab-address<?php echo $address_row; ?>\']').parent().remove(); $('#tab-address<?php echo $address_row; ?>').remove();"></i>
										<?php echo $tab_address . ' ' . $address_row; ?> </a></li>
								<?php $address_row++; ?>
								<?php } ?>
								<li id="address-add"><a onclick="addAddress();"><i
										class="icon-plus-sign"></i> <?php echo $button_add_address; ?>
								</a></li>
							</ul>
							<div class="tab-content">
								<div class="tab-pane active" id="tab-customer">
									...
									<div class="control-group">
										<label class="control-label" for="input-confirm"><?php echo $entry_confirm; ?>
										</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label" for="input-newsletter"><?php echo $entry_newsletter; ?>
										</label>
										<div class="controls">
								...
								<div class="tab-pane"
									...
									<div class="control-group">
										<label class="control-label"
											for="input-firstname<?php echo $address_row; ?>"><span
											class="required">*</span> <?php echo $entry_firstname; ?> </label>
										<div class="controls">
											<input type="text"
											...
											<span class="error"><?php echo $error_address_firstname[$address_row]; ?>
											</span>
											<?php } ?>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"
											for="input-lastname<?php echo $address_row; ?>"><span
											class="required">*</span> <?php echo $entry_lastname; ?> </label>
										<div class="controls">
											<input type="text"
											...
											<span class="error"><?php echo $error_address_lastname[$address_row]; ?>
											</span>
											<?php } ?>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"
											for="input-company<?php echo $address_row; ?>"><?php echo $entry_company; ?>
										</label>
										<div class="controls">
											<input type="text"
									...
									<div class="control-group">
										<label class="control-label"
											for="input-address-1<?php echo $address_row; ?>"><span
										...
										<div class="controls">
											...
											<span class="error"><?php echo $error_address_address_1[$address_row]; ?>
											</span>
											<?php } ?>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"
											for="input-address-2<?php echo $address_row; ?>"><?php echo $entry_address_2; ?>
										</label>
										<div class="controls">
											<input type="text"
									...
									<div class="control-group">
										<label class="control-label"
											for="input-city<?php echo $address_row; ?>"><span
										...
										<div class="controls">
											...
											<span class="error"><?php echo $error_address_city[$address_row]; ?>
											</span>
											<?php } ?>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"
											for="input-postcode<?php echo $address_row; ?>"> <span
											id="postcode-required<?php echo $address_row; ?>"
									...
									<div class="control-group">
										<label class="control-label"
											for="input-country<?php echo $address_row; ?>"><span
										...
										<div class="controls">
											...
											<span class="error"><?php echo $error_address_country[$address_row]; ?>
											</span>
											<?php } ?>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label"
											for="input-zone<?php echo $address_row; ?>"><span
										...
										<div class="controls">
											...
											<span class="error"><?php echo $error_address_zone[$address_row]; ?>
											</span>
											<?php } ?>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<label class="radio"> <?php if (($address['address_id'] == $address_id) || !$addresses) { ?>
												<input type="radio"
												name="address[<?php echo $address_row; ?>][default]"
												value="<?php echo $address_row; ?>" checked="checked" /> <?php } else { ?>
												<input type="radio"
												name="address[<?php echo $address_row; ?>][default]"
												value="<?php echo $address_row; ?>" /> <?php } ?>
											</label>
										</div>
									</div>
								</div>
					...
					<div class="tab-pane" id="tab-history">
						...
						<button id="button-history" class="btn">
							<i class="icon-plus-sign"></i>
							<?php echo $button_add_history; ?>
						</button>
					</div>
					<div class="tab-pane" id="tab-transaction">
						<div id="transaction"></div>
						<div class="control-group">
							<label class="control-label" for="input-transaction-description"><?php echo $entry_description; ?>
							</label>
							<div class="controls">
						...
						<div class="control-group">
							<label class="control-label" for="input-amount"><?php echo $entry_amount; ?>
							</label>
							<div class="controls">
						...
						<button id="button-transaction" class="btn">
							<i class="icon-plus-sign"></i>
							<?php echo $button_add_transaction; ?>
						</button>
					</div>
					<div class="tab-pane" id="tab-reward">
						<div id="reward"></div>
						<div class="control-group">
							<label class="control-label" for="input-reward-description"><?php echo $entry_description; ?>
							</label>
							<div class="controls">
								<input type="text" name="description" value=""
									placeholder="<?php echo $entry_description; ?>"
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<a data-toggle="tooltip" title="<?php echo $help_points; ?>"><i
									class="icon-info-sign"></i> </a>

							</div>
						</div>
						<button id="button-reward" class="btn">
							<i class="icon-plus-sign"></i>
							<?php echo $button_add_reward; ?>
						</button>
					</div>
					<?php } ?>
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="right"><a href="<?php echo $ip['filter_ip']; ?>"
										target="_blank"><?php echo $ip['total']; ?> </a></td>
									<td class="left"><?php echo $ip['date_added']; ?></td>
									<td class="right"><?php if ($ip['ban_ip']) { ?>
										<button value="<?php echo $ip['ip']; ?>"
											class="btn btn-mini button-ban-add">
											<i class="icon-minus-sign"></i>
											<?php echo $text_remove_ban_ip; ?>
										</button> <?php } else { ?>
										<button value="<?php echo $ip['ip']; ?>" class="btn btn-mini">
											<i class="icon-plus-sign"></i>
											<?php echo $text_add_ban_ip; ?>
										</button> <?php } ?></td>
								</tr>
								<?php } ?>
								<?php } else { ?>
								<tr>
									<td class="center" colspan="4"><?php echo $text_no_results; ?>
									</td>
								</tr>
								<?php } ?>
							</tbody>
...
function addAddress() {	
	...
	html += '    <div class="controls"><select name="address[' + address_row + '][zone_id]" id="input-zone' + address_row + '"><option value="false"><?php _e('text_none'); ?></option></select></div>';
	html += '  </div>'; 
