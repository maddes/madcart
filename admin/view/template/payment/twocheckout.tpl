	...
	<div class="box">
		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					<label class="control-label" for="input-secret"><?php echo $entry_secret; ?>
					</label>
					<div class="controls">
						...
						<a data-toggle="tooltip" title="<?php echo $help_secret; ?>"><i
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="radio inline"> <?php if ($twocheckout_test) { ?> <input
							type="radio" name="twocheckout_test" value="1" checked="checked" />
							<?php echo $text_yes; ?> <?php } else { ?> <input type="radio"
							name="twocheckout_test" value="1" /> <?php echo $text_yes; ?> <?php } ?>
						</label> <label class="radio inline"> <?php if (!$twocheckout_test) { ?>
							<input type="radio" name="twocheckout_test" value="0"
							checked="checked" /> <?php echo $text_no; ?> <?php } else { ?> <input
							type="radio" name="twocheckout_test" value="0" /> <?php echo $text_no; ?>
							<?php } ?>
						</label>
					</div>
				</div>
				<div class="control-group">
					<tr>
						...
						<td><?php if ($twocheckout_display) { ?> <input type="radio"
							name="twocheckout_display" value="1" checked="checked" /> <?php echo $text_yes; ?>
							<input type="radio" name="twocheckout_display" value="0" /> <?php echo $text_no; ?>
							<?php } else { ?> <input type="radio" name="twocheckout_display"
							value="1" /> <?php echo $text_yes; ?> <input type="radio"
							name="twocheckout_display" value="0" checked="checked" /> <?php echo $text_no; ?>
							<?php } ?></td>
					</tr>
				</div>
				<div class="control-group">
