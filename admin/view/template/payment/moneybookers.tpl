		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="moneybookers_email"
							value="<?php echo $moneybookers_email; ?>"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="moneybookers_secret"
							value="<?php echo $moneybookers_secret; ?>"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="moneybookers_total"
							value="<?php echo $moneybookers_total; ?>"
				...
				<div class="control-group">
					<label class="control-label" for="input-canceled-status"><?php echo $entry_canceled_status; ?>
					</label>
					<div class="controls">
						<select name="moneybookers_canceled_status_id"
							id="input-canceled-status">
							<?php foreach ($order_statuses as $order_status) { ?>
				...
				<div class="control-group">
					<label class="control-label" for="input-chargeback-status"><?php echo $entry_chargeback_status; ?>
					</label>
					<div class="controls">
						<select name="moneybookers_chargeback_status_id"
							id="input-chargeback-status">
							<?php foreach ($order_statuses as $order_status) { ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="moneybookers_sort_order"
							value="<?php echo $moneybookers_sort_order; ?>"
							placeholder="<?php echo $entry_sort_order; ?>"
							id="input-sort-order" class="input-small" />
					</div>
				</div>
			</form>
		</div>
