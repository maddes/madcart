		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="worldpay_merchant"
							value="<?php echo $worldpay_merchant; ?>"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="worldpay_password"
							value="<?php echo $worldpay_password; ?>"
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<a data-toggle="tooltip" title="<?php echo $help_callback; ?>"><i
							class="icon-info-sign"></i> </a>
