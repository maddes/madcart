		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					<label class="control-label" for="input-login"><span
						class="required">*</span> <?php echo $entry_login; ?> </label>
					<div class="controls">
				...
				<div class="control-group">
					<label class="control-label" for="input-hash"><?php echo $entry_hash; ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label class="control-label" for="input-server"><?php echo $entry_server; ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label class="control-label" for="input-mode"><?php echo $entry_mode; ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="authorizenet_aim_method" id="input-method">
							...
							<option value="authorization" selected="selected">
