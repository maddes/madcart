		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="radio inline"> <?php if ($paymate_test) { ?> <input
							type="radio" name="paymate_test" value="1" checked="checked" /> <?php echo $text_yes; ?>
							<?php } else { ?> <input type="radio" name="paymate_test"
							value="1" /> <?php echo $text_yes; ?> <?php } ?>
						</label> <label class="radio inline"> <?php if (!$paymate_test) { ?>
							<input type="radio" name="paymate_test" value="0"
							checked="checked" /> <?php echo $text_no; ?> <?php } else { ?> <input
							type="radio" name="paymate_test" value="0" /> <?php echo $text_no; ?>
							<?php } ?>
						</label>
					</div>
				</div>
