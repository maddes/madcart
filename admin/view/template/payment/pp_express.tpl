		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="radio inline"> <?php if ($pp_express_test) { ?> <input
							type="radio" name="pp_express_test" value="1" checked="checked" />
							<?php echo $text_yes; ?> <?php } else { ?> <input type="radio"
							name="pp_express_test" value="1" /> <?php echo $text_yes; ?> <?php } ?>
						</label> <label class="radio inline"> <?php if (!$pp_express_test) { ?>
							<input type="radio" name="pp_express_test" value="0"
							checked="checked" /> <?php echo $text_no; ?> <?php } else { ?> <input
							type="radio" name="pp_express_test" value="0" /> <?php echo $text_no; ?>
							<?php } ?>
						</label>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="input-method"><?php echo $entry_method; ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="pp_express_total"
							value="<?php echo $pp_express_total; ?>" id="input-total" /> <a
