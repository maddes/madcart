		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					<label class="control-label" for="input-merchant-id"><span
						class="required">*</span> <?php echo $entry_merchant_id; ?> </label>
					<div class="controls">
						<input type="text" name="google_checkout_merchant_id"
							value="<?php echo $google_checkout_merchant_id; ?>"
				...
				<div class="control-group">
					<label class="control-label" for="input-merchant-key"><span
						class="required">*</span> <?php echo $entry_merchant_key; ?> </label>
					<div class="controls">
						<input type="text" name="google_checkout_merchant_key"
							value="<?php echo $google_checkout_merchant_key; ?>"
							placeholder="<?php echo $entry_merchant_key; ?>"
							id="input-merchant-key" />
				...
				<div class="control-group">
					<label class="control-label" for="input-callback"><?php echo $entry_callback; ?>
					</label>
					<div class="controls">
						<textarea cols="40" rows="5" id="input-callback"
							readonly="readonly">
							<?php echo $callback; ?>
						</textarea>
					</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="radio inline"> <?php if ($google_checkout_test) { ?>
							<input type="radio" name="google_checkout_test" value="1"
							checked="checked" /> <?php echo $text_yes; ?> <?php } else { ?> <input
							type="radio" name="google_checkout_test" value="1" /> <?php echo $text_yes; ?>
							<?php } ?>
						</label> <label class="radio inline"> <?php if (!$google_checkout_test) { ?>
							<input type="radio" name="google_checkout_test" value="0"
							checked="checked" /> <?php echo $text_no; ?> <?php } else { ?> <input
							type="radio" name="google_checkout_test" value="0" /> <?php echo $text_no; ?>
							<?php } ?>
						</label>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="google_checkout_total"
							value="<?php echo $google_checkout_total; ?>"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="google_checkout_sort_order"
							value="<?php echo $google_checkout_sort_order; ?>"
