		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="sagepay_vendor"
							value="<?php echo $sagepay_vendor; ?>"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="sagepay_password"
							value="<?php echo $sagepay_password; ?>"
				...
				<div class="control-group">
					<label class="control-label" for="input-test"><?php echo $entry_test; ?>
					</label>
					<div class="controls">
						<select name="sagepay_test" id="input-test">
							<?php if ($sagepay_test == 'sim') { ?>
							<option value="sim" selected="selected">
								<?php echo $text_sim; ?>
							</option>
							<?php } else { ?>
							<option value="sim">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="sagepay_transaction" id="input-transaction">
							...
							<option value="DEFERRED" selected="selected">
								<?php echo $text_defered; ?>
							</option>
							<?php } else { ?>
							...
							<option value="AUTHENTICATE" selected="selected">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="sagepay_total"
							value="<?php echo $sagepay_total; ?>"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="sagepay_sort_order"
							value="<?php echo $sagepay_sort_order; ?>"
