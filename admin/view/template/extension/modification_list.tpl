	...
	<div class="box">
		...
		<div class="box-content">
			<form action="<?php echo $delete; ?>" method="post"
				...
				<div class="buttons">
					<a href="<?php echo $refresh; ?>" class="btn"><i
						class="icon-refresh"></i> <?php echo $button_refresh; ?> </a> <a
						href="<?php echo $clear; ?>" class="btn"><?php echo $button_clear; ?>
