						...
						<div class="tab-pane"
							...
							<div class="control-group">
								<label class="control-label"
									for="input-rate<?php echo $geo_zone['geo_zone_id']; ?>"><?php echo $entry_rate; ?>
								</label>
								<div class="controls">
									<textarea
										...
										<?php echo ${
											'weight_' . $geo_zone['geo_zone_id'] . '_rate'}; ?>
									</textarea>
							...
							<div class="control-group">
								<label class="control-label"
									for="input-status<?php echo $geo_zone['geo_zone_id']; ?>"><?php echo $entry_status; ?>
								</label>
								<div class="controls">
									<select
										...
										<?php if (${
'weight_' . $geo_zone['geo_zone_id'] . '_status'}) { ?>
										<option value="1" selected="selected">
											<?php echo $text_enabled; ?>
										</option>
										<option value="0">
