	...
	<div class="box">
		...
		<div class="box-content">
			<form action="<?php echo $action; ?>" method="post"
				...
				<div class="control-group">
					<label class="control-label" for="input-standard"><?php echo $entry_standard ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label class="control-label" for="input-express"><?php echo $entry_express; ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label class="control-label" for="input-display-time"><?php echo $entry_display_time; ?>
					</label>
					<div class="controls">
