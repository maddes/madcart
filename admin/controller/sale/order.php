...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	protected function getList() {
		...
		$this->data['text_missing'] = __('text_missing');
		...
		$this->data['button_invoice'] = __('button_invoice');
  	...
  	public function getForm() {
		...
		$this->data['entry_address'] = __('entry_address');
		...
		$this->data['entry_zone_code'] = __('entry_zone_code');
		$this->data['entry_country'] = __('entry_country');		
		$this->data['entry_product'] = __('entry_product');
		$this->data['entry_option'] = __('entry_option');
		...
		$this->data['entry_reward'] = __('entry_reward');
		...
		$this->data['button_add_product'] = __('button_add_product');
		$this->data['button_add_voucher'] = __('button_add_voucher');
		$this->data['button_update_total'] = __('button_update_total');
		$this->data['button_upload'] = __('button_upload');

		$this->data['tab_order'] = __('tab_order');
		$this->data['tab_customer'] = __('tab_customer');
		$this->data['tab_payment'] = __('tab_payment');
		$this->data['tab_shipping'] = __('tab_shipping');
		$this->data['tab_product'] = __('tab_product');
		$this->data['tab_voucher'] = __('tab_voucher');
		$this->data['tab_total'] = __('tab_total');
  	...
  	protected function validateForm() {
		...
		if ($country_info && $country_info['postcode_required'] && (utf8_strlen($this->request->post['payment_postcode']) < 2) || (utf8_strlen($this->request->post['payment_postcode']) > 10)) {
			$this->error['payment_postcode'] = __('error_postcode');
		}

    	if ($this->request->post['payment_country_id'] == '') {
      		$this->error['payment_country'] = __('error_country');
    	}
		
    	if (!isset($this->request->post['payment_zone_id']) || $this->request->post['payment_zone_id'] == '') {
      		$this->error['payment_zone'] = __('error_zone');
    	}	
		...
		if (!$this->request->post['payment_method']) {
			$this->error['payment_method'] = __('error_payment');
		}	
		...
		if ($shipping) {
			...
			if ($country_info && $country_info['postcode_required'] && (utf8_strlen($this->request->post['shipping_postcode']) < 2) || (utf8_strlen($this->request->post['shipping_postcode']) > 10)) {
				$this->error['shipping_postcode'] = __('error_postcode');
			}
	
			if ($this->request->post['shipping_country_id'] == '') {
				$this->error['shipping_country'] = __('error_country');
			}
			
			if (!isset($this->request->post['shipping_zone_id']) || $this->request->post['shipping_zone_id'] == '') {
				$this->error['shipping_zone'] = __('error_zone');
			}
			
			if (!$this->request->post['shipping_method']) {
				$this->error['shipping_method'] = __('error_shipping');
			}			
		}
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->data['text_invoice_date'] = __('text_invoice_date');
			$this->data['text_store_name'] = __('text_store_name');
			$this->data['text_store_url'] = __('text_store_url');		
			...
			$this->data['text_commission'] = __('text_commission');
			$this->data['text_ip'] = __('text_ip');
			$this->data['text_forwarded_ip'] = __('text_forwarded_ip');
			$this->data['text_user_agent'] = __('text_user_agent');
			$this->data['text_accept_language'] = __('text_accept_language');
			$this->data['text_date_added'] = __('text_date_added');
			$this->data['text_date_modified'] = __('text_date_modified');			
			...
			$this->data['text_zone_code'] = __('text_zone_code');
			...
			$this->data['text_generate'] = __('text_generate');
			$this->data['text_reward_add'] = __('text_reward_add');
			$this->data['text_reward_remove'] = __('text_reward_remove');
			$this->data['text_commission_add'] = __('text_commission_add');
			$this->data['text_commission_remove'] = __('text_commission_remove');
			$this->data['text_credit_add'] = __('text_credit_add');
			$this->data['text_credit_remove'] = __('text_credit_remove');
			$this->data['text_country_match'] = __('text_country_match');
			$this->data['text_country_code'] = __('text_country_code');
			$this->data['text_high_risk_country'] = __('text_high_risk_country');
			$this->data['text_distance'] = __('text_distance');
			$this->data['text_ip_region'] = __('text_ip_region');
			$this->data['text_ip_city'] = __('text_ip_city');
			$this->data['text_ip_latitude'] = __('text_ip_latitude');
			$this->data['text_ip_longitude'] = __('text_ip_longitude');
			$this->data['text_ip_isp'] = __('text_ip_isp');
			$this->data['text_ip_org'] = __('text_ip_org');
			$this->data['text_ip_asnum'] = __('text_ip_asnum');
			$this->data['text_ip_user_type'] = __('text_ip_user_type');
			$this->data['text_ip_country_confidence'] = __('text_ip_country_confidence');
			$this->data['text_ip_region_confidence'] = __('text_ip_region_confidence');
			$this->data['text_ip_city_confidence'] = __('text_ip_city_confidence');
			$this->data['text_ip_postal_confidence'] = __('text_ip_postal_confidence');
			$this->data['text_ip_postal_code'] = __('text_ip_postal_code');
			$this->data['text_ip_accuracy_radius'] = __('text_ip_accuracy_radius');
			$this->data['text_ip_net_speed_cell'] = __('text_ip_net_speed_cell');
			$this->data['text_ip_metro_code'] = __('text_ip_metro_code');
			$this->data['text_ip_area_code'] = __('text_ip_area_code');
			$this->data['text_ip_time_zone'] = __('text_ip_time_zone');
			$this->data['text_ip_region_name'] = __('text_ip_region_name');
			$this->data['text_ip_domain'] = __('text_ip_domain');
			$this->data['text_ip_country_name'] = __('text_ip_country_name');
			$this->data['text_ip_continent_code'] = __('text_ip_continent_code');
			$this->data['text_ip_corporate_proxy'] = __('text_ip_corporate_proxy');
			$this->data['text_anonymous_proxy'] = __('text_anonymous_proxy');
			$this->data['text_proxy_score'] = __('text_proxy_score');
			$this->data['text_is_trans_proxy'] = __('text_is_trans_proxy');
			$this->data['text_free_mail'] = __('text_free_mail');
			$this->data['text_carder_email'] = __('text_carder_email');
			$this->data['text_high_risk_username'] = __('text_high_risk_username');
			$this->data['text_high_risk_password'] = __('text_high_risk_password');
			$this->data['text_bin_match'] = __('text_bin_match');
			$this->data['text_bin_country'] = __('text_bin_country');
			$this->data['text_bin_name_match'] = __('text_bin_name_match');
			$this->data['text_bin_name'] = __('text_bin_name');
			$this->data['text_bin_phone_match'] = __('text_bin_phone_match');
			$this->data['text_bin_phone'] = __('text_bin_phone');
			$this->data['text_customer_phone_in_billing_location'] = __('text_customer_phone_in_billing_location');
			$this->data['text_ship_forward'] = __('text_ship_forward');
			$this->data['text_city_postal_match'] = __('text_city_postal_match');
			$this->data['text_ship_city_postal_match'] = __('text_ship_city_postal_match');
			$this->data['text_score'] = __('text_score');
			$this->data['text_explanation'] = __('text_explanation');
			$this->data['text_risk_score'] = __('text_risk_score');
			$this->data['text_queries_remaining'] = __('text_queries_remaining');
			$this->data['text_maxmind_id'] = __('text_maxmind_id');
			$this->data['text_error'] = __('text_error');

			$this->data['help_country_match'] = __('help_country_match');
			$this->data['help_country_code'] = __('help_country_code');
			$this->data['help_high_risk_country'] = __('help_high_risk_country');
			$this->data['help_distance'] = __('help_distance');
			$this->data['help_ip_region'] = __('help_ip_region');
			$this->data['help_ip_city'] = __('help_ip_city');
			$this->data['help_ip_latitude'] = __('help_ip_latitude');
			$this->data['help_ip_longitude'] = __('help_ip_longitude');
			$this->data['help_ip_isp'] = __('help_ip_isp');
			$this->data['help_ip_org'] = __('help_ip_org');
			$this->data['help_ip_asnum'] = __('help_ip_asnum');
			$this->data['help_ip_user_type'] = __('help_ip_user_type');
			$this->data['help_ip_country_confidence'] = __('help_ip_country_confidence');
			$this->data['help_ip_region_confidence'] = __('help_ip_region_confidence');
			$this->data['help_ip_city_confidence'] = __('help_ip_city_confidence');
			$this->data['help_ip_postal_confidence'] = __('help_ip_postal_confidence');
			$this->data['help_ip_postal_code'] = __('help_ip_postal_code');
			$this->data['help_ip_accuracy_radius'] = __('help_ip_accuracy_radius');
			$this->data['help_ip_net_speed_cell'] = __('help_ip_net_speed_cell');
			$this->data['help_ip_metro_code'] = __('help_ip_metro_code');
			$this->data['help_ip_area_code'] = __('help_ip_area_code');
			$this->data['help_ip_time_zone'] = __('help_ip_time_zone');
			$this->data['help_ip_region_name'] = __('help_ip_region_name');
			$this->data['help_ip_domain'] = __('help_ip_domain');
			$this->data['help_ip_country_name'] = __('help_ip_country_name');
			$this->data['help_ip_continent_code'] = __('help_ip_continent_code');
			$this->data['help_ip_corporate_proxy'] = __('help_ip_corporate_proxy');
			$this->data['help_anonymous_proxy'] = __('help_anonymous_proxy');
			$this->data['help_proxy_score'] = __('help_proxy_score');
			$this->data['help_is_trans_proxy'] = __('help_is_trans_proxy');
			$this->data['help_free_mail'] = __('help_free_mail');
			$this->data['help_carder_email'] = __('help_carder_email');
			$this->data['help_high_risk_username'] = __('help_high_risk_username');
			$this->data['help_high_risk_password'] = __('help_high_risk_password');
			$this->data['help_bin_match'] = __('help_bin_match');
			$this->data['help_bin_country'] = __('help_bin_country');
			$this->data['help_bin_name_match'] = __('help_bin_name_match');
			$this->data['help_bin_name'] = __('help_bin_name');
			$this->data['help_bin_phone_match'] = __('help_bin_phone_match');
			$this->data['help_bin_phone'] = __('help_bin_phone');
			$this->data['help_customer_phone_in_billing_location'] = __('help_customer_phone_in_billing_location');
			$this->data['help_ship_forward'] = __('help_ship_forward');
			$this->data['help_city_postal_match'] = __('help_city_postal_match');
			$this->data['help_ship_city_postal_match'] = __('help_ship_city_postal_match');
			$this->data['help_score'] = __('help_score');
			$this->data['help_explanation'] = __('help_explanation');
			$this->data['help_risk_score'] = __('help_risk_score');
			$this->data['help_queries_remaining'] = __('help_queries_remaining');
			$this->data['help_maxmind_id'] = __('help_maxmind_id');
			$this->data['help_error'] = __('help_error');
			...
			$this->data['column_price'] = __('column_price');
			$this->data['column_total'] = __('column_total');
			$this->data['column_download'] = __('column_download');
			$this->data['column_filename'] = __('column_filename');
			$this->data['column_remaining'] = __('column_remaining');
						
			$this->data['entry_order_status'] = __('entry_order_status');
			$this->data['entry_notify'] = __('entry_notify');
			$this->data['entry_comment'] = __('entry_comment');
			
			$this->data['button_invoice'] = __('button_invoice');
			$this->data['button_cancel'] = __('button_cancel');
			$this->data['button_add_history'] = __('button_add_history');
		
			$this->data['tab_order'] = __('tab_order');
			$this->data['tab_payment'] = __('tab_payment');
			$this->data['tab_shipping'] = __('tab_shipping');
			$this->data['tab_product'] = __('tab_product');
			$this->data['tab_history'] = __('tab_history');
			$this->data['tab_fraud'] = __('tab_fraud');
			...
			$this->data['date_modified'] = date(__('date_format_short'), strtotime($order_info['date_modified']));		
			$this->data['payment_firstname'] = $order_info['payment_firstname'];
			$this->data['payment_lastname'] = $order_info['payment_lastname'];
			$this->data['payment_company'] = $order_info['payment_company'];
			$this->data['payment_address_1'] = $order_info['payment_address_1'];
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['customer_id']) {
				...
				if (!$credit_total) {
					$this->model_sale_customer->addTransaction($order_info['customer_id'], __('text_order_id') . ' #' . $this->request->get['order_id'], $order_info['total'], $this->request->get['order_id']);
					
					$json['success'] = __('text_credit_added');
				} else {
					$json['error'] = __('error_action');
				}
			}
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['customer_id']) {
				...
				$json['success'] = __('text_credit_removed');
			} else {
				$json['error'] = __('error_action');
			}
		}
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['customer_id'] && ($order_info['reward'] > 0)) {
				...
				if (!$reward_total) {
					$this->model_sale_customer->addReward($order_info['customer_id'], __('text_order_id') . ' #' . $this->request->get['order_id'], $order_info['reward'], $this->request->get['order_id']);
					
					$json['success'] = __('text_reward_added');
				} else {
					$json['error'] = __('error_action'); 
				}
			} else {
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['customer_id']) {
				...
				$json['success'] = __('text_reward_removed');
			} else {
				$json['error'] = __('error_action');
			}
		}
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['affiliate_id']) {
				...
				if (!$affiliate_total) {
					$this->model_sale_affiliate->addTransaction($order_info['affiliate_id'], __('text_order_id') . ' #' . $this->request->get['order_id'], $order_info['commission'], $this->request->get['order_id']);
					
					$json['success'] = __('text_commission_added');
				} else {
					$json['error'] = __('error_action'); 
				}
			} else {
		...
		$json = array(); 
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['affiliate_id']) {
				...
				$json['success'] = __('text_commission_removed');
			} else {
				$json['error'] = __('error_action');
			}
		}
	...
	public function history() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			if (!$this->user->hasPermission('modify', 'sale/order')) { 
				$this->data['error'] = __('error_permission');
			}
			
			if (!$this->data['error']) { 
				$this->model_sale_order->addOrderHistory($this->request->get['order_id'], $this->request->post);
				
				$this->data['success'] = __('text_success');
			}
		}
		...
		$this->data['column_date_added'] = __('column_date_added');
		$this->data['column_status'] = __('column_status');
		$this->data['column_notify'] = __('column_notify');
		...
		foreach ($results as $result) {
        	$this->data['histories'][] = array(
				'notify'     => $result['notify'] ? __('text_yes') : __('text_no'),
				'status'     => $result['status'],
	...
	public function upload() {
  	...
  	public function invoice() {
		...
		$this->data['title'] = __('heading_title');
		...
		$this->data['text_invoice'] = __('text_invoice');
		...
		$this->data['text_telephone'] = __('text_telephone');
		$this->data['text_fax'] = __('text_fax');
		$this->data['text_to'] = __('text_to');
		$this->data['text_ship_to'] = __('text_ship_to');
		$this->data['text_payment_method'] = __('text_payment_method');
		$this->data['text_shipping_method'] = __('text_shipping_method');
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$this->data['orders'][] = array(
					...
					'date_added'         => date(__('date_format_short'), strtotime($order_info['date_added'])),
