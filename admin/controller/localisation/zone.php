	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['zones'][] = array(
					...
					'name'     => $result['name'] . (($result['zone_id'] == $this->config->get('config_zone_id')) ? __('text_default') : null),
					'code'     => $result['code'],
		...
		$this->data['results'] = sprintf(__('text_pagination'), ($zone_total) ? (($page - 1) * $this->config->get('config_admin_limit')) + 1 : 0, ((($page - 1) * $this->config->get('config_admin_limit')) > ($zone_total - $this->config->get('config_admin_limit'))) ? $zone_total : ((($page - 1) * $this->config->get('config_admin_limit')) + $this->config->get('config_admin_limit')), $zone_total, ceil($zone_total / $this->config->get('config_admin_limit')));
