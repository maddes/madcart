...
class ControllerLocalisationReturnReason extends Controller {
	...
	protected function getList() {
		...
		$this->data['results'] = sprintf(__('text_pagination'), ($return_reason_total) ? (($page - 1) * $this->config->get('config_admin_limit')) + 1 : 0, ((($page - 1) * $this->config->get('config_admin_limit')) > ($return_reason_total - $this->config->get('config_admin_limit'))) ? $return_reason_total : ((($page - 1) * $this->config->get('config_admin_limit')) + $this->config->get('config_admin_limit')), $return_reason_total, ceil($return_reason_total / $this->config->get('config_admin_limit')));
