...
class ControllerSettingStore extends Controller {
	...
	protected function getList() {
		...
		$this->data['stores'][] = array(
				'store_id' => 0,
				'name'     => $this->config->get('config_name') . __('text_default'),
				'url'      => HTTP_CATALOG,
		...
		$this->data['column_url'] = __('column_url');
	...
	public function getForm() {
		...
		$this->data['entry_url'] = __('entry_url');
		$this->data['entry_ssl'] = __('entry_ssl');
		...
		$this->data['entry_ajax_cart'] = __('entry_ajax_cart');
		...
		$this->data['help_url'] = __('help_url');
		$this->data['help_ssl'] = __('help_ssl');
