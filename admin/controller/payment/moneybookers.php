...
class ControllerPaymentMoneyBookers extends Controller {
	...
	public function index() {
		...
		$this->data['entry_canceled_status'] = __('entry_canceled_status');	
		$this->data['entry_failed_status'] = __('entry_failed_status');	
		$this->data['entry_chargeback_status'] = __('entry_chargeback_status');	
		$this->data['entry_geo_zone'] = __('entry_geo_zone');
		$this->data['entry_status'] = __('entry_status');
		$this->data['entry_sort_order'] = __('entry_sort_order');
		$this->data['entry_mb_id'] = __('entry_mb_id');
		$this->data['entry_secret'] = __('entry_secret');
		$this->data['entry_custnote'] = __('entry_custnote');
