...
class ControllerCatalogAttribute extends Controller { 
  	...
  	protected function getList() {
		...
		$this->data['column_attribute_group'] = __('column_attribute_group');
		...
		$this->data['results'] = sprintf(__('text_pagination'), ($attribute_total) ? (($page - 1) * $this->config->get('config_admin_limit')) + 1 : 0, ((($page - 1) * $this->config->get('config_admin_limit')) > ($attribute_total - $this->config->get('config_admin_limit'))) ? $attribute_total : ((($page - 1) * $this->config->get('config_admin_limit')) + $this->config->get('config_admin_limit')), $attribute_total, $attribute_total, ceil($attribute_total / $this->config->get('config_admin_limit')));
  	...
  	protected function getForm() {
		...
		$this->data['entry_attribute_group'] = __('entry_attribute_group');
